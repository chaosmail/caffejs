...
define("NumJS/Array", ["require", "exports"], function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.DEFAULT_TYPE_INSTANCE = Float32Array;
    function zeros(n, dtype) {
        if (dtype === void 0) { dtype = exports.DEFAULT_TYPE_INSTANCE; }
        return new dtype(n);
    }
    exports.zeros = zeros;
    function fill(A, b) {
...
define("NumJS/MinMax", ["require", "exports"], function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    function max(A) {
...
define("NumJS/Random", ["require", "exports"], function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var cached = false;
    var cachedVal = 0.0;
...
define("NumJS/Utils", ["require", "exports"], function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("NumJS/_module", ["require", "exports", "NumJS/Array", "NumJS/MinMax", "NumJS/Random", "NumJS/Utils"], function (require, exports, Array_1, MinMax_1, Random_1, Utils_1) {
    "use strict";
    function __export(m) {
...
define("Net/Vol", ["require", "exports", "NumJS/_module"], function (require, exports, nj) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var Vol = (function () {
...
define("ImgJS/Image", ["require", "exports", "es6-shim", "Net/Vol", "NumJS/_module"], function (require, exports, es6_shim_1, Vol_1, nj) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    // TODO
    ...
    var Image = (function () {
        ...
        Image.fromVol = function (vol, mean, channel, scale, normalize, aplha) {
            ...
            for (var y = 0; y < h; y++) {
                for (var x = 0; x < w; x++) {
                    var pp = (y * w + x) * 4;
                    var mean_0 = mean ? mean instanceof Vol_1.default ? mean.get(x, y, c0) : +mean[c0] : 0;
                    var mean_1 = mean ? mean instanceof Vol_1.default ? mean.get(x, y, c1) : +mean[c1] : 0;
                    var mean_2 = mean ? mean instanceof Vol_1.default ? mean.get(x, y, c2) : +mean[c2] : 0;
        ...
        Image.prototype.toVol = function (mean, channel) {
            ...
            var c1 = channel[1];
            var c2 = channel[2];
            var vol = new Vol_1.default(w, h, 3, 0.0);
            for (var y = 0; y < h; y++) {
                for (var x = 0; x < w; x++) {
                    var pp = (y * w + x) * 4;
                    var mean_0 = mean instanceof Vol_1.default ? mean.get(x, y, c0) : +mean[c0];
                    var mean_1 = mean instanceof Vol_1.default ? mean.get(x, y, c1) : +mean[c1];
                    var mean_2 = mean instanceof Vol_1.default ? mean.get(x, y, c2) : +mean[c2];
...
define("Parser/TextParser", ["require", "exports"], function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("Parser/PrototxtParser", ["require", "exports", "Parser/TextParser"], function (require, exports, TextParser_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    }(TextParser_1.TextParser));
    exports.default = PrototxtParser;
});
define("Net/ILayer", ["require", "exports"], function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
});
define("Net/Net", ["require", "exports", "d3", "NumJS/_module"], function (require, exports, d3, nj) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var Net = (function () {
        function Net() {
...
define("Net/Utils", ["require", "exports", "NumJS/_module"], function (require, exports, nj) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("Net/Layers/BaseLayer", ["require", "exports", "NumJS/_module"], function (require, exports, nj) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("Net/Layers/ConcatLayer", ["require", "exports", "Net/Layers/BaseLayer", "Net/Vol", "Net/Utils", "NumJS/_module"], function (require, exports, BaseLayer_1, Vol_2, Utils_2, nj) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var ConcatLayer = (function (_super) {
        ...
        function ConcatLayer(opt) {
            ...
            _this.axis = Utils_2.getopt(opt, ['axis'], 1);
        ...
        ConcatLayer.prototype.forward = function (Vs, is_training) {
            this.in_act = Vs;
            this.resetGradient();
            var V2 = new Vol_2.default(this.out_sx, this.out_sy, this.out_depth, 0.0);
            var offset = 0;
            if (this.axis === 0) {
                var V2w = V2.w;
    ...
    exports.default = ConcatLayer;
});
define("Net/Layers/ConvLayer", ["require", "exports", "Net/Layers/BaseLayer", "Net/Vol", "Net/Utils", "NumJS/_module"], function (require, exports, BaseLayer_2, Vol_3, Utils_3, nj) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var ConvLayer = (function (_super) {
        ...
        function ConvLayer(opt) {
            ...
            _this.sx = opt.sx;
            // optional
            _this.sy = Utils_3.getopt(opt, ['sy'], _this.sx);
            // stride at which we apply filters to input volume
            _this.stride = Utils_3.getopt(opt, ['stride'], 1);
            // amount of 0 padding to add around borders of input volume
            _this.pad = Utils_3.getopt(opt, ['pad'], 0);
            // Convolution groups from AlexNet
            _this.conv_groups = Utils_3.getopt(opt, ['group'], 1);
            _this.l1_decay_mul = Utils_3.getopt(opt, ['l1_decay_mul'], 0.0);
            _this.l2_decay_mul = Utils_3.getopt(opt, ['l2_decay_mul'], 1.0);
            _this.updateDimensions(opt.pred);
            // initialize bias
            var bias = Utils_3.getopt(opt, ['bias_pref'], 0.0);
            _this.biases = new Vol_3.default(1, 1, _this.out_depth, bias);
            // initialize filters
            _this.filters = [];
            var f_depth = Math.ceil(_this.in_depth / _this.conv_groups);
            for (var i = 0; i < _this.out_depth; ++i) {
                _this.filters.push(new Vol_3.default(_this.sx, _this.sy, f_depth, 0.0));
            }
            return _this;
        }
        ...
        ConvLayer.prototype.forward = function (V, is_training) {
            ...
            this.in_act = V;
            this.resetGradient();
            var A = new Vol_3.default(this.out_sx | 0, this.out_sy | 0, this.out_depth | 0, 0.0);
            var V_sx = V.sx | 0;
            var V_sy = V.sy | 0;
        ...
        ConvLayer.prototype.fromJSON = function (json) {
            ...
            for (var i = 0; i < json.filters.length; i++) {
                this.filters.push(Vol_3.default.fromJSON(json.filters[i]));
            }
            this.biases = Vol_3.default.fromJSON(json.biases);
        };
        return ConvLayer;
    }(BaseLayer_2.default));
    exports.default = ConvLayer;
});
define("Net/Layers/DropoutLayer", ["require", "exports", "Net/Layers/BaseLayer", "Net/Utils", "NumJS/_module"], function (require, exports, BaseLayer_3, Utils_4, nj) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    var DropoutLayer = (function (_super) {
        ...
        function DropoutLayer(opt) {
            ...
            _this.drop_prob = Utils_4.getopt(opt, ['drop_prob'], 0.5);
            _this.updateDimensions(opt.pred);
            return _this;
        }
...
define("Net/Layers/FullyConnectedLayer", ["require", "exports", "Net/Layers/BaseLayer", "Net/Vol", "Net/Utils", "NumJS/_module"], function (require, exports, BaseLayer_4, Vol_4, Utils_5, nj) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var FullyConnectedLayer = (function (_super) {
        ...
        function FullyConnectedLayer(opt) {
            ...
            // optional 
            _this.l1_decay_mul = Utils_5.getopt(opt, ['l1_decay_mul'], 0.0);
            _this.l2_decay_mul = Utils_5.getopt(opt, ['l2_decay_mul'], 1.0);
            _this.updateDimensions(opt.pred);
            // initialize bias
            var bias = Utils_5.getopt(opt, ['bias_pref'], 0.0);
            _this.biases = new Vol_4.default(1, 1, _this.out_depth, bias);
            // initialize filters
            _this.filters = [];
            for (var i = 0; i < _this.out_depth; ++i) {
                _this.filters.push(new Vol_4.default(1, 1, _this.num_inputs, 0.0));
            }
        ...
        FullyConnectedLayer.prototype.forward = function (V, is_training) {
            this.in_act = V;
            this.resetGradient();
            var A = new Vol_4.default(1, 1, this.out_depth, 0.0);
            var Vw = V.w;
            for (var i = 0; i < this.out_depth; ++i) {
                var a = 0.0;
        ...
        FullyConnectedLayer.prototype.fromJSON = function (json) {
            ...
            this.filters = [];
            for (var i = 0; i < json.filters.length; i++) {
                this.filters.push(Vol_4.default.fromJSON(json.filters[i]));
            }
            this.biases = Vol_4.default.fromJSON(json.biases);
        };
        return FullyConnectedLayer;
    }(BaseLayer_4.default));
    exports.default = FullyConnectedLayer;
});
define("Net/Layers/InputLayer", ["require", "exports", "Net/Layers/BaseLayer", "Net/Utils"], function (require, exports, BaseLayer_5, Utils_6) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var InputLayer = (function (_super) {
        ...
        function InputLayer(opt) {
            ...
            // required: depth
            _this.in_depth = Utils_6.getopt(opt, ['in_depth', 'out_depth', 'depth'], 0);
            // optional: default these dimensions to 1
            _this.in_sx = Utils_6.getopt(opt, ['in_sx', 'out_sx', 'sx', 'width'], 1);
            _this.in_sy = Utils_6.getopt(opt, ['in_sy', 'out_sy', 'sy', 'height'], 1);
...
define("Net/Layers/LocalResponseNormalizationLayer", ["require", "exports", "Net/Layers/BaseLayer"], function (require, exports, BaseLayer_6) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    exports.default = LocalResponseNormalizationLayer;
});
define("Net/Layers/MaxoutLayer", ["require", "exports", "Net/Layers/BaseLayer", "Net/Vol", "NumJS/_module"], function (require, exports, BaseLayer_7, Vol_5, nj) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    var MaxoutLayer = (function (_super) {
        ...
        MaxoutLayer.prototype.forward = function (V, is_training) {
            ...
            var V2 = new Vol_5.default(this.out_sx, this.out_sy, this.out_depth, 0.0);
    ...
    exports.default = MaxoutLayer;
});
define("Net/Layers/PoolLayer", ["require", "exports", "Net/Layers/BaseLayer", "Net/Vol", "Net/Utils", "NumJS/_module"], function (require, exports, BaseLayer_8, Vol_6, Utils_7, nj) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var PoolLayer = (function (_super) {
        ...
        function PoolLayer(opt) {
            ...
            // filter size. Should be odd if possible, it's cleaner.
            _this.sx = opt.sx;
            _this.pool = Utils_7.getopt(opt, ['pool'], 'MAX');
            ;
            // optional
            _this.sy = Utils_7.getopt(opt, ['sy'], _this.sx);
            // stride at which we apply filters to input volume
            _this.stride = Utils_7.getopt(opt, ['stride'], 1);
            // amount of 0 padding to add around borders of input volume
            _this.pad = Utils_7.getopt(opt, ['pad'], 0);
            _this.updateDimensions(opt.pred);
            return _this;
        }
        PoolLayer.prototype.forward = function (V, is_training) {
            ...
            var A = new Vol_6.default(this.out_sx, this.out_sy, this.out_depth, 0.0);
            if (this.pool === 'AVE') {
    ...
    exports.default = PoolLayer;
});
define("Net/Layers/RegressionLayer", ["require", "exports", "Net/Layers/BaseLayer"], function (require, exports, BaseLayer_9) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    exports.default = RegressionLayer;
});
define("Net/Layers/ReluLayer", ["require", "exports", "Net/Layers/BaseLayer"], function (require, exports, BaseLayer_10) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    var ReluLayer = (function (_super) {
        ...
        return ReluLayer;
    }(BaseLayer_10.default));
    exports.default = ReluLayer;
});
define("Net/Layers/SVMLayer", ["require", "exports", "Net/Layers/BaseLayer"], function (require, exports, BaseLayer_11) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    // implements an L2 regression cost layer,
    // so penalizes \sum_i(||x_i - y_i||^2), where x is its input
    ...
    var SVMLayer = (function (_super) {
        ...
        return SVMLayer;
    }(BaseLayer_11.default));
    exports.default = SVMLayer;
});
define("Net/Layers/SigmoidLayer", ["require", "exports", "Net/Layers/BaseLayer"], function (require, exports, BaseLayer_12) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    var SigmoidLayer = (function (_super) {
        ...
        return SigmoidLayer;
    }(BaseLayer_12.default));
    exports.default = SigmoidLayer;
});
define("Net/Layers/SoftmaxLayer", ["require", "exports", "Net/Layers/BaseLayer", "Net/Vol", "NumJS/_module"], function (require, exports, BaseLayer_13, Vol_7, nj) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    var SoftmaxLayer = (function (_super) {
        ...
        SoftmaxLayer.prototype.forward = function (V, is_training) {
            this.in_act = V;
            this.resetGradient();
            var A = new Vol_7.default(1, 1, this.out_depth, 0.0);
        ...
        return SoftmaxLayer;
    }(BaseLayer_13.default));
    exports.default = SoftmaxLayer;
});
define("Net/Layers/TanhLayer", ["require", "exports", "Net/Layers/BaseLayer", "NumJS/_module"], function (require, exports, BaseLayer_14, nj) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    var TanhLayer = (function (_super) {
        ...
        return TanhLayer;
    }(BaseLayer_14.default));
    exports.default = TanhLayer;
});
define("Net/Layers/_module", ["require", "exports", "Net/Layers/BaseLayer", "Net/Layers/ConcatLayer", "Net/Layers/ConvLayer", "Net/Layers/DropoutLayer", "Net/Layers/FullyConnectedLayer", "Net/Layers/InputLayer", "Net/Layers/LocalResponseNormalizationLayer", "Net/Layers/MaxoutLayer", "Net/Layers/PoolLayer", "Net/Layers/RegressionLayer", "Net/Layers/ReluLayer", "Net/Layers/SVMLayer", "Net/Layers/SigmoidLayer", "Net/Layers/SoftmaxLayer", "Net/Layers/TanhLayer"], function (require, exports, BaseLayer_15, ConcatLayer_1, ConvLayer_1, DropoutLayer_1, FullyConnectedLayer_1, InputLayer_1, LocalResponseNormalizationLayer_1, MaxoutLayer_1, PoolLayer_1, RegressionLayer_1, ReluLayer_1, SVMLayer_1, SigmoidLayer_1, SoftmaxLayer_1, TanhLayer_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.BaseLayer = BaseLayer_15.default;
    exports.ConcatLayer = ConcatLayer_1.default;
    exports.ConvLayer = ConvLayer_1.default;
    exports.DropoutLayer = DropoutLayer_1.default;
    exports.FullyConnectedLayer = FullyConnectedLayer_1.default;
    exports.InputLayer = InputLayer_1.default;
    exports.LocalResponseNormalizationLayer = LocalResponseNormalizationLayer_1.default;
    exports.MaxoutLayer = MaxoutLayer_1.default;
    exports.PoolLayer = PoolLayer_1.default;
    exports.RegressionLayer = RegressionLayer_1.default;
    exports.ReluLayer = ReluLayer_1.default;
    exports.SVMLayer = SVMLayer_1.default;
    exports.SigmoidLayer = SigmoidLayer_1.default;
    exports.SoftmaxLayer = SoftmaxLayer_1.default;
    exports.TanhLayer = TanhLayer_1.default;
});
define("Net/CaffeModel", ["require", "exports", "d3", "Parser/PrototxtParser", "Net/Net", "Net/Layers/_module"], function (require, exports, d3, PrototxtParser_1, Net_1, Layers) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var CaffeModel = (function (_super) {
        ...
        CaffeModel.prototype.fromText = function (def) {
            var protoParser = new PrototxtParser_1.default();
        ...
        CaffeModel.prototype.caffeLayerToJs = function (layerOpt) {
            ...
            switch (layerOpt.type.toLowerCase()) {
                ...
                case 'innerproduct':
                    ...
                    break;
                case 'softmax':
                    layer = new Layers.SoftmaxLayer(opt);
                    break;
                case 'relu':
                    layer = new Layers.ReluLayer(opt);
                    break;
                case 'sigmoid':
                    layer = new Layers.SigmoidLayer(opt);
                    break;
                case 'tanh':
                    layer = new Layers.TanhLayer(opt);
                    break;
                default:
    ...
    exports.default = CaffeModel;
});
define("Parser/BinaryParser", ["require", "exports"], function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("Parser/BinaryprotoParser", ["require", "exports", "Parser/BinaryParser", "./Protobuf"], function (require, exports, BinaryParser_1, Protobuf_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var BinaryprotoParser = (function (_super) {
        ...
        BinaryprotoParser.prototype.parseBuffer = function (raw) {
            var _ = Protobuf_1.dcodeIO.ProtoBuf.newBuilder({})['import']({
                "package": "caffe",
                "messages": [
                    {
                        "name": "BlobShape",
    ...
    }(BinaryParser_1.BinaryParser));
    exports.BinaryprotoParser = BinaryprotoParser;
});
define("Parser/BlobProtoParser", ["require", "exports", "Parser/BinaryprotoParser", "Net/Vol"], function (require, exports, BinaryprotoParser_1, Vol_8) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var BlobProtoParser = (function (_super) {
        ...
        BlobProtoParser.prototype.parseProto = function (rawData, protoParser) {
            ...
            var vol = new Vol_8.default(sx, sy, depth, 0.0);
    ...
    }(BinaryprotoParser_1.BinaryprotoParser));
    exports.default = BlobProtoParser;
});
define("Utils/ActivationDrawer", ["require", "exports", "d3", "Net/Net", "ImgJS/Image"], function (require, exports, d3, Net_2, Image_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
        ...
        ActivationDrawer.prototype.render = function (element, renderInput, maxElementsPerLayer, width, height) {
            ...
            this.layerIterator(function (layer, j) {
                ...
                for (var i = 0, len = layer.out_act.depth; i < len; ++i) {
                    ...
                    // }
                    Image_1.default.fromFilter(A, i, 1).render($canv[0][0]);
                }
            });
        };
    ...
    exports.default = ActivationDrawer;
});
define("Utils/GraphDrawer", ["require", "exports", "d3", "dagre-d3", "Net/Net"], function (require, exports, d3, dagreD3, Net_3) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
